...
def __getattr__(name: str) -> Any:
    ...
    _lazy = {
        "SmartDataSplitter": "artenic_ai_sdk_training.data_splitting",
        "DataSplitResult": "artenic_ai_sdk_training.data_splitting",
        "DatasetVersioner": "artenic_ai_sdk_training.data_versioning",
        "DatasetVersion": "artenic_ai_sdk_training.data_versioning",
        "MixedPrecisionManager": "artenic_ai_sdk_training.mixed_precision",
        "PrecisionMode": "artenic_ai_sdk_training.mixed_precision",
        "GradientCheckpointManager": "artenic_ai_sdk_training.gradient_checkpoint",
        "SmartCheckpointer": "artenic_ai_sdk_training.checkpointing",
        "EarlyStopping": "artenic_ai_sdk_training.early_stopping",
        "LearningRateFinder": "artenic_ai_sdk_training.lr_finder",
        "LRFinderResult": "artenic_ai_sdk_training.lr_finder",
        "FSDPManager": "artenic_ai_sdk_training.distributed",
        "DistributedContext": "artenic_ai_sdk_training.distributed",
    }
    if name in _lazy:
        import importlib
