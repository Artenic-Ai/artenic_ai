"""Tests for artenic_ai_sdk.training — config, callbacks, and all features."""
...
class TestSmartCheckpointer:
    ...
    def test_sigterm_handler_on_non_windows(self, tmp_path: Path) -> None:
        ...
        with patch("artenic_ai_sdk.training.checkpointing.sys") as mock_sys:
            mock_sys.platform = "linux"
            with patch("artenic_ai_sdk.training.checkpointing.signal") as mock_signal:
...
class TestSmartDataSplitter:
    def _make_splitter(self, **kwargs: Any) -> Any:
        from artenic_ai_sdk.training.data_splitting import SmartDataSplitter
...
class TestDatasetVersioner:
    def test_hash_file(self, tmp_path: Path) -> None:
        from artenic_ai_sdk.training.data_versioning import DatasetVersioner
...
class TestMixedPrecisionManager:
    def test_detect_no_torch(self) -> None:
        from artenic_ai_sdk.training.mixed_precision import MixedPrecisionManager
...
class TestGradientCheckpointManager:
    def test_off_mode(self) -> None:
        from artenic_ai_sdk.training.gradient_checkpoint import (
            GradientCheckpointManager,
        )
...
class TestLearningRateFinder:
    def test_find_steepest_descent_basic(self) -> None:
        from artenic_ai_sdk.training.lr_finder import LearningRateFinder
    ...
    def test_lr_finder_result_dataclass(self) -> None:
        from artenic_ai_sdk.training.lr_finder import LRFinderResult
...
class TestFSDPManager:
    ...
    def test_distributed_context_dataclass(self) -> None:
        from artenic_ai_sdk.training.distributed import DistributedContext
...
class TestBuildCallbacks:
    def test_empty_config(self) -> None:
        from artenic_ai_sdk.training import build_callbacks
...
class TestLazyImports:
    def test_import_smart_data_splitter(self) -> None:
        from artenic_ai_sdk.training import SmartDataSplitter
        from artenic_ai_sdk.training.data_splitting import (
    ...
    def test_import_dataset_versioner(self) -> None:
        from artenic_ai_sdk.training import DatasetVersioner
        from artenic_ai_sdk.training.data_versioning import (
    ...
    def test_import_mixed_precision_manager(self) -> None:
        from artenic_ai_sdk.training import MixedPrecisionManager
        from artenic_ai_sdk.training.mixed_precision import (
    ...
    def test_import_early_stopping(self) -> None:
        from artenic_ai_sdk.training import EarlyStopping
        from artenic_ai_sdk.training.early_stopping import (
    ...
    def test_import_lr_finder(self) -> None:
        from artenic_ai_sdk.training import LearningRateFinder
        from artenic_ai_sdk.training.lr_finder import (
    ...
    def test_import_fsdp_manager(self) -> None:
        from artenic_ai_sdk.training import FSDPManager
        from artenic_ai_sdk.training.distributed import FSDPManager as DirectImport

        assert FSDPManager is DirectImport

    def test_import_gradient_checkpoint_manager(self) -> None:
        from artenic_ai_sdk.training import GradientCheckpointManager
        from artenic_ai_sdk.training.gradient_checkpoint import (
    ...
    def test_getattr_nonexistent_raises(self) -> None:
        import artenic_ai_sdk.training as training_mod
