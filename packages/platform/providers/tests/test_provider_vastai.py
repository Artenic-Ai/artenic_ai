"""Tests for artenic_ai_platform_providers.vastai — VastAIProvider."""
...
_MODULE = "artenic_ai_platform_providers.vastai"
...
@pytest.fixture()
def provider():
    from artenic_ai_platform_providers.vastai import VastAIProvider
...
class TestVastAIPoll:
    ...
    async def test_poll_running_instance(self, connected):
        provider, mock_client = connected
        from artenic_ai_platform_providers.vastai import (
            _VastJobState,
        )
