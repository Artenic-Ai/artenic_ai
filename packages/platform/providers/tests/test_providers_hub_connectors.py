"""Tests for artenic_ai_platform_providers.hub.connectors — OpenStack connector."""
...
class TestCatalog:
    ...
    def test_infomaniak_in_catalog(self) -> None:
        from artenic_ai_platform_providers.hub.catalog import get_provider_definition
