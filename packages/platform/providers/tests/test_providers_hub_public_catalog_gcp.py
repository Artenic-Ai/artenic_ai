...
class TestGcpGetRequiresHttpx:
    async def test_raises_import_error(self) -> None:
        fetcher = GcpCatalogFetcher()
        with (
            patch("artenic_ai_platform_providers.hub.public_catalog.gcp.httpx", None),
    ...
    async def test_get_success(self) -> None:
        ...
        with patch("artenic_ai_platform_providers.hub.public_catalog.gcp.httpx") as mock_httpx:
