...
class TestGcpTestConnection:
    async def test_success(self) -> None:
        ...
        with (
            ...
            patch("artenic_ai_platform_providers.hub.connectors.gcp.compute_v1") as mock_compute,
        ):
...
class TestGcpListStorage:
    async def test_returns_buckets(self) -> None:
        ...
        with (
            patch.object(connector, "_credentials", return_value=mock_creds),
            patch("artenic_ai_platform_providers.hub.connectors.gcp.gcs") as mock_gcs,
        ):
