"""Tests for artenic_ai_platform_providers.azure — AzureProvider."""
...
_MODULE = "artenic_ai_platform_providers.azure"
...
def _make_provider(**overrides):
    ...
    from artenic_ai_platform_providers.azure import AzureProvider
...
class TestAzurePollProvider:
    async def test_poll_running(self, azure_patches):
        from artenic_ai_platform_providers.azure import _AzureJobState
...
class TestAzureParseGpuFromVmName:
    ...
    def test_parse_gpu_known_family(self):
        from artenic_ai_platform_providers.azure import _parse_gpu_from_vm_name
