"""Tests for artenic_ai_platform_providers.aws — AWSProvider."""
...
_MODULE = "artenic_ai_platform_providers.aws"
...
def _make_provider(**overrides):
    ...
    from artenic_ai_platform_providers.aws import AWSProvider
