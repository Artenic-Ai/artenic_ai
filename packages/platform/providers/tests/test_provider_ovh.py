"""Tests for artenic_ai_platform_providers.ovh — OVHProvider."""
...
def _patch_openstack(monkeypatch):
    ...
    import artenic_ai_platform_providers.ovh as ovh_mod
...
def _build_provider():
    ...
    from artenic_ai_platform_providers.ovh import OVHProvider
...
class TestOVHEstimateCost:
    def test_estimate_cost_with_price(self):
        from artenic_ai_platform_providers.ovh import _OVHJobState
...
class TestOVHGPUParsingEdgeCases:
    ...
    def test_parse_gpu_count_multi_gpu(self):
        from artenic_ai_platform_providers.ovh import _parse_gpu_count_from_name
    ...
    def test_parse_gpu_type_generic_fallback(self):
        from artenic_ai_platform_providers.ovh import _parse_gpu_type_from_name
