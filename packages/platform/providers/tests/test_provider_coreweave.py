"""Tests for artenic_ai_platform_providers.coreweave — CoreWeaveProvider."""
...
_MODULE = "artenic_ai_platform_providers.coreweave"
...
def provider(_patch_k8s):
    from artenic_ai_platform_providers.coreweave import (
        CoreWeaveProvider,
    )
...
class TestCoreWeaveConnectFallback:
    ...
    async def test_connect_incluster_fails_loads_kubeconfig(self, _patch_k8s):
        ...
        from artenic_ai_platform_providers.coreweave import CoreWeaveProvider
...
class TestCoreWeaveCollectArtifactsEdgeCases:
    ...
    async def test_collect_pod_log_api_exception(self, provider, _patch_k8s):
        ...
        from artenic_ai_platform_providers.coreweave import _CoreWeaveJobState
...
class TestCoreWeaveParseK8sCpu:
    ...
    def test_millicpu(self):
        from artenic_ai_platform_providers.coreweave import _parse_k8s_cpu
...
class TestCoreWeaveParseK8sMemoryGb:
    ...
    def test_ki_suffix(self):
        """Ki suffix (line 764)."""
        from artenic_ai_platform_providers.coreweave import _parse_k8s_memory_gb
...
class TestCoreWeaveIsNodeReady:
    ...
    def test_node_status_none(self):
        ...
        from artenic_ai_platform_providers.coreweave import _is_node_ready
...
class TestCoreWeaveSafeJson:
    ...
    def test_safe_json_normal(self):
        from artenic_ai_platform_providers.coreweave import _safe_json
