...
class TestAwsGetRequiresHttpx:
    async def test_raises_import_error(self) -> None:
        fetcher = AwsCatalogFetcher()
        with (
            patch("artenic_ai_platform_providers.hub.public_catalog.aws.httpx", None),
    ...
    async def test_get_success(self) -> None:
        ...
        with patch("artenic_ai_platform_providers.hub.public_catalog.aws.httpx") as mock_httpx:
