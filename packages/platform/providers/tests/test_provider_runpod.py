"""Tests for artenic_ai_platform_providers.runpod — RunPodProvider."""
...
_MODULE = "artenic_ai_platform_providers.runpod"
...
@pytest.fixture()
def provider():
    from artenic_ai_platform_providers.runpod import RunPodProvider
...
class TestRunPodPoll:
    ...
    async def test_poll_running_pod(self, connected_provider):
        provider, mock_client = connected_provider
        from artenic_ai_platform_providers.runpod import (
            _RunPodJobState,
        )
