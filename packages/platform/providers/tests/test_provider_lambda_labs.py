"""Tests for artenic_ai_platform_providers.lambda_labs — LambdaLabsProvider."""
...
_MODULE = "artenic_ai_platform_providers.lambda_labs"
...
def provider():
    ...
    from artenic_ai_platform_providers.lambda_labs import (
        LambdaLabsProvider,
    )
...
class TestLambdaLabsCleanupEdgeCases:
    ...
    async def test_cleanup_non_success_status(self, provider):
        ...
        from artenic_ai_platform_providers.lambda_labs import _LambdaJobState
