...
from artenic_ai_platform_providers.hub.catalog import (
    PROVIDER_CATALOG,
...
if TYPE_CHECKING:
    ...
    from artenic_ai_platform_providers.hub.connectors.base import ProviderConnector
...
def _get_connector(connector_type: str, provider_id: str) -> ProviderConnector:
    ...
    if connector_type == "openstack":
        ...
        from artenic_ai_platform_providers.hub.connectors.scaleway import (
            ScalewayConnector,
        )
        ...
        from artenic_ai_platform_providers.hub.connectors.gcp import (
            GcpConnector,
        )
...
from artenic_ai_platform_providers.hub.public_catalog.base import CatalogCache  # noqa: E402
...
def _get_catalog_fetcher(provider_id: str) -> CatalogFetcher:
    ...
    if provider_id == "ovh":
        ...
        from artenic_ai_platform_providers.hub.public_catalog.aws import (
            AwsCatalogFetcher,
        )

        fetcher = AwsCatalogFetcher()
    elif provider_id == "gcp":
        from artenic_ai_platform_providers.hub.public_catalog.gcp import (
            GcpCatalogFetcher,
        )
