...
class TestAzureGetRequiresHttpx:
    async def test_raises_import_error(self) -> None:
        fetcher = AzureCatalogFetcher()
        with (
            patch("artenic_ai_platform.providers_hub.public_catalog.azure.httpx", None),
    ...
    async def test_get_success(self) -> None:
        ...
        with patch("artenic_ai_platform.providers_hub.public_catalog.azure.httpx") as mock_httpx:
