...
from artenic_ai_platform.providers_hub.public_catalog.vastai import VastaiCatalogFetcher
...
class TestVastaiGetRequiresHttpx:
    async def test_raises_import_error(self) -> None:
        fetcher = VastaiCatalogFetcher()
        with (
            patch("artenic_ai_platform.providers_hub.public_catalog.vastai.httpx", None),
    ...
    async def test_get_success(self) -> None:
        ...
        with patch("artenic_ai_platform.providers_hub.public_catalog.vastai.httpx") as mock_httpx:
