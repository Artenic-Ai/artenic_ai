...
from artenic_ai_platform.providers_hub.public_catalog.base import CatalogCache, CatalogFetcher
...
class TestCatalogCache:
    ...
    def test_expired_entry_returns_none(self) -> None:
        ...
        with patch("artenic_ai_platform.providers_hub.public_catalog.base.time") as mock_time:
