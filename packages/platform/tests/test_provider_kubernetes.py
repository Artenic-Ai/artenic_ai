"""Tests for artenic_ai_platform.providers.kubernetes — KubernetesProvider."""
...
_MODULE = "artenic_ai_platform.providers.kubernetes"
...
def provider(_patch_k8s):
    from artenic_ai_platform.providers.kubernetes import (
        KubernetesProvider,
    )
