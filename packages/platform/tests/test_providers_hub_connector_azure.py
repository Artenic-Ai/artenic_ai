...
class TestAzureTestConnection:
    async def test_success(self) -> None:
        ...
        with (
            ...
            patch(
                "artenic_ai_platform.providers_hub.connectors.azure.ComputeManagementClient",
...
class TestAzureListStorage:
    ...
    async def test_returns_containers(self) -> None:
        ...
        with (
            patch.object(connector, "_credential", return_value=mock_cred),
            patch(
                "artenic_ai_platform.providers_hub.connectors.azure.BlobServiceClient",
...
class TestAzureListRegions:
    async def test_returns_locations(self) -> None:
        ...
        with (
            patch.object(connector, "_credential", return_value=mock_cred),
            patch(
                "artenic_ai_platform.providers_hub.connectors.azure.SubscriptionClient",
