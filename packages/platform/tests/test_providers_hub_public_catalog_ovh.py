...
class TestOvhGetRequiresHttpx:
    async def test_raises_import_error(self) -> None:
        fetcher = OvhCatalogFetcher()
        with (
            patch("artenic_ai_platform.providers_hub.public_catalog.ovh.httpx", None),
    ...
    async def test_get_success(self) -> None:
        ...
        with patch("artenic_ai_platform.providers_hub.public_catalog.ovh.httpx") as mock_httpx:
