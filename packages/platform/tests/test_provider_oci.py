"""Tests for artenic_ai_platform.providers.oci — OCIProvider."""
...
_MODULE = "artenic_ai_platform.providers.oci"
...
def _make_provider(**overrides):
    ...
    from artenic_ai_platform.providers.oci import OCIProvider
...
class TestOCIPollProvider:
    async def test_poll_running(self, oci_patches):
        from artenic_ai_platform.providers.oci import _OCIJobState
...
class TestOCIShapeToDictMissingAttrs:
    ...
    def test_shape_to_dict_no_ocpus(self, oci_patches):
        from artenic_ai_platform.providers.oci import _shape_to_dict
