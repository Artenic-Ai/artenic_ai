"""Tests for artenic_ai_platform.providers.infomaniak — InfomaniakProvider."""
...
def _build_provider():
    from artenic_ai_platform.providers.infomaniak import InfomaniakProvider
...
class TestInfomaniakEstimateCost:
    def test_with_hourly_price(self):
        from artenic_ai_platform.providers.infomaniak import (
            _InfomaniakJobState,
        )
