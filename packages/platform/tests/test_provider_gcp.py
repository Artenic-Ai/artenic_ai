"""Tests for artenic_ai_platform.providers.gcp — GCPProvider."""
...
_MODULE = "artenic_ai_platform.providers.gcp"
...
def _make_provider(**overrides):
    ...
    from artenic_ai_platform.providers.gcp import GCPProvider
...
class TestWaitForZoneOperation:
    def test_operation_error(self, gcp_patches):
        from artenic_ai_platform.providers.gcp import _wait_for_zone_operation
...
class TestParseSerialMetrics:
    def test_training_failed_marker(self):
        from artenic_ai_platform.providers.gcp import _parse_serial_metrics
...
class TestShouldSkip:
    def test_skip_pycache(self):
        from artenic_ai_platform.providers.gcp import _should_skip
