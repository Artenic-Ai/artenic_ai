"""Tests for artenic_ai_platform.providers.local — LocalProvider behaviour."""
...
import artenic_ai_platform.providers.local as local_module
from artenic_ai_platform.providers.base import (
    InstanceType,
    JobStatus,
    TrainingSpec,
)
from artenic_ai_platform.providers.local import (
    LocalProvider,
