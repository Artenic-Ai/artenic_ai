"""Tests for artenic_ai_platform.providers.scaleway — ScalewayProvider."""
...
def _patch_httpx(monkeypatch):
    ...
    import artenic_ai_platform.providers.scaleway as scw_mod
...
def _build_provider(**kwargs):
    from artenic_ai_platform.providers.scaleway import ScalewayProvider
...
class TestScalewayInit:
    ...
    def test_init_raises_without_httpx(self, monkeypatch):
        import artenic_ai_platform.providers.scaleway as mod
...
class TestScalewayEstimateCost:
    def test_estimate_with_price(self):
        from artenic_ai_platform.providers.scaleway import (
            _ScalewayJobState,
        )
...
class TestScalewayDetectGPUEdgeCases:
    ...
    def test_detect_gpu_from_api_response(self):
        from artenic_ai_platform.providers.scaleway import _detect_gpu
