"""Tests for artenic_ai_platform.providers.hetzner -- HetznerProvider."""
...
def _patch_hcloud(monkeypatch):
    ...
    import artenic_ai_platform.providers.hetzner as hetzner_mod
...
def _build_provider(**kwargs):
    from artenic_ai_platform.providers.hetzner import HetznerProvider
...
class TestHetznerInit:
    ...
    def test_init_raises_without_hcloud(self, monkeypatch):
        import artenic_ai_platform.providers.hetzner as mod
...
class TestHetznerEstimateCost:
    def test_estimate_with_hourly_price(self):
        from artenic_ai_platform.providers.hetzner import (
            _HetznerJobState,
        )
...
class TestHetznerEstimateCostNoPriceWithInstanceType:
    def test_estimate_cost_no_hourly_price_but_instance_type_set(self):
        from artenic_ai_platform.providers.hetzner import _HetznerJobState
...
class TestGPUParsingHelpers:
    def test_parse_gpu_count_from_name(self):
        from artenic_ai_platform.providers.hetzner import _parse_gpu_count
    ...
    def test_parse_gpu_type_known(self):
        from artenic_ai_platform.providers.hetzner import _parse_gpu_type
