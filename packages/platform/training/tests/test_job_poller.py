"""Tests for artenic_ai_platform_training.job_poller — background polling loop."""
...
from artenic_ai_platform_providers.base import JobStatus, TrainingSpec
from artenic_ai_platform_providers.mock import MockProvider
from artenic_ai_platform_training.job_poller import JobPoller
...
class TestPollNoChangeStatus:
    ...
    async def test_poll_no_change_status(
        ...
        from artenic_ai_platform_providers.base import CloudJobStatus
