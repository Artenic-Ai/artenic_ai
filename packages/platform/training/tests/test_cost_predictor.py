"""Tests for artenic_ai_platform_training.cost_predictor."""
...
from artenic_ai_platform_training.cost_predictor import CostPredictor
...
class TestPredictCostUnavailableInstance:
    ...
    async def test_predict_cost_unavailable_instance(self) -> None:
        from artenic_ai_platform_providers.base import InstanceType
