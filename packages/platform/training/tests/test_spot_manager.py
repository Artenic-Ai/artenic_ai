"""Tests for artenic_ai_platform_training.spot_manager."""
...
from artenic_ai_platform_providers.base import CloudJobStatus, JobStatus
from artenic_ai_platform_training.spot_manager import SpotManager
